...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws Exception {
        ...
        question.setQuestionIcon("vwndQbG79g1qeLPpjE8kSJEerOOumzgJdO6O0XMEYhYcvDu7gx");
        question.setQuestionDetails("DYRa6WF5rY");
        question.setQuestion("fHqSMt5RwQ8C5MDeIx757DjuAnYq5RQFh2TOT2A0rrKQOQ6utk");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionIcon("OzKoCCTJaPpI38BWyKoEBzYKmgPhHv7pyW03cwj1ke1SdyYRbz");
            question.setQuestionDetails("4jwog3lfQO");
            question.setQuestion("JH84eMtyo5nLE6g0mJOgfyJDULFhUriuwTE3QOxlSmyNNa6La7");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "NNpbCuV9M8vkxXRrAOATT79UOCiHemv63suo6rSTCY19F3d4OItLQ5bIpy6xpSBAS"));
