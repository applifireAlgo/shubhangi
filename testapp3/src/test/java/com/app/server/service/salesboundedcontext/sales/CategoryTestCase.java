...
public class CategoryTestCase extends EntityTestCriteria {
    ...
    private Category createCategory(Boolean isSave) throws Exception {
        ...
        category.setCategory("yBGw0XduHtHInBYSSRfyo8twyk18vum9QUo5RakIY6kCMELMQH");
    ...
    public void test2Update() {
        try {
            ...
            category.setCategory("v4yXop6IxRMUfMwi7OZ5qTibOvd3vaWTlbvVn5xpq7Hh5kuyXI");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(NOT_NULL, 1, "category", null));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "category", "2xv55le1fDM0fziFxou56YtEzzWW45WJRAUTuoEnjXw7Uya6hox2xTxfZ6wRPL9uF"));
            ...
            try {
                ...
                switch(((contraints.getTestId()))) {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        category.setCategory(contraints.getNegativeValue().toString());
                        validateCategory(contraints, category);
                        failureCount++;
                        break;
                }
