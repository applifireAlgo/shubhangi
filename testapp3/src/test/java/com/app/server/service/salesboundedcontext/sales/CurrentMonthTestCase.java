...
public class CurrentMonthTestCase extends EntityTestCriteria {
    ...
    private CurrentMonth createCurrentMonth(Boolean isSave) throws Exception {
        ...
        currentmonth.setMonthname("FcO833TmRIlHRMwAwzBdZX6F6IOhZHulb2Oky3NJF1ENh0Fw2M");
    ...
    public void test2Update() {
        try {
            ...
            currentmonth.setMonthname("BQT7L2kE4Bf2ES7BGcmIQ1p9Qo2hZ6a5yoeoV1Pddx9GesCH0B");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "monthname", "PioqHycLhHQokKzqFBc0t6Uc0Leyb6peY7b1mHU87pUbRMiypoZ7iqYBloTaiKest"));
