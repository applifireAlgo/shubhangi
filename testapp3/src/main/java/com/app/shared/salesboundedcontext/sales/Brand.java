...
@SourceCodeAuthorClass(createdBy = "shubhangivhanale@gmail.com", updatedBy = "shubhangivhanale@gmail.com", versionNumber = "3", comments = "Brand", complexity = Complexity.LOW)
...
public class Brand implements Serializable, CommonEntityInterface, Comparator<Brand> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.salesboundedcontext.sales.Brand other = (com.app.shared.salesboundedcontext.sales.Brand) obj;
            if (brandcode == null) {
                return false;
