...
@SourceCodeAuthorClass(createdBy = "shubhangivhanale@gmail.com", updatedBy = "shubhangivhanale@gmail.com", versionNumber = "3", comments = "Category", complexity = Complexity.LOW)
...
public class Category implements Serializable, CommonEntityInterface, Comparator<Category> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.salesboundedcontext.sales.Category other = (com.app.shared.salesboundedcontext.sales.Category) obj;
            if (categoryId == null) {
                return false;
