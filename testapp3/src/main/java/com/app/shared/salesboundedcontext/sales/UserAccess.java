...
@SourceCodeAuthorClass(createdBy = "shubhangivhanale@gmail.com", updatedBy = "shubhangivhanale@gmail.com", versionNumber = "3", comments = "UserAccess", complexity = Complexity.LOW)
...
public class UserAccess implements Serializable, CommonEntityInterface, Comparator<UserAccess> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.salesboundedcontext.sales.UserAccess other = (com.app.shared.salesboundedcontext.sales.UserAccess) obj;
            if (userAccessId == null) {
                return false;
