...
@SourceCodeAuthorClass(createdBy = "shubhangivhanale@gmail.com", updatedBy = "shubhangivhanale@gmail.com", versionNumber = "3", comments = "Material", complexity = Complexity.LOW)
...
public class Material implements Serializable, CommonEntityInterface, Comparator<Material> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.salesboundedcontext.sales.Material other = (com.app.shared.salesboundedcontext.sales.Material) obj;
            if (materialcode == null) {
                return false;
