...
@SourceCodeAuthorClass(createdBy = "shubhangivhanale@gmail.com", updatedBy = "shubhangivhanale@gmail.com", versionNumber = "2", comments = "User", complexity = Complexity.LOW)
...
public class User implements Serializable, CommonEntityInterface, UserInterface, Comparator<User> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.appbasicsetup.usermanagement.User other = (com.app.shared.appbasicsetup.usermanagement.User) obj;
            if (userId == null) {
                return false;
