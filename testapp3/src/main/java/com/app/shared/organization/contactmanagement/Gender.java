...
@SourceCodeAuthorClass(createdBy = "shubhangivhanale@gmail.com", updatedBy = "shubhangivhanale@gmail.com", versionNumber = "2", comments = "Gender", complexity = Complexity.LOW)
...
public class Gender implements Serializable, CommonEntityInterface, Comparator<Gender> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.organization.contactmanagement.Gender other = (com.app.shared.organization.contactmanagement.Gender) obj;
            if (genderId == null) {
                return false;
