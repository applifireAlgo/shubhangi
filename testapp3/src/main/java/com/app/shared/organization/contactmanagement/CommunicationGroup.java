...
@SourceCodeAuthorClass(createdBy = "shubhangivhanale@gmail.com", updatedBy = "shubhangivhanale@gmail.com", versionNumber = "2", comments = "CommunicationGroup", complexity = Complexity.LOW)
...
public class CommunicationGroup implements Serializable, CommonEntityInterface, Comparator<CommunicationGroup> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.organization.contactmanagement.CommunicationGroup other = (com.app.shared.organization.contactmanagement.CommunicationGroup) obj;
            if (commGroupId == null) {
                return false;
