...
@SourceCodeAuthorClass(createdBy = "shubhangivhanale@gmail.com", updatedBy = "shubhangivhanale@gmail.com", versionNumber = "2", comments = "Title", complexity = Complexity.LOW)
...
public class Title implements Serializable, CommonEntityInterface, Comparator<Title> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.organization.contactmanagement.Title other = (com.app.shared.organization.contactmanagement.Title) obj;
            if (titleId == null) {
                return false;
