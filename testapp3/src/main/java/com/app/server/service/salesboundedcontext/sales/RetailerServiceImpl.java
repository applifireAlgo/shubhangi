...
public class RetailerServiceImpl extends RetailerService {
    ...
    public HttpEntity<ResponseBean> findAll() throws Exception {
        java.util.List<com.app.shared.salesboundedcontext.sales.Retailer> lstretailer = retailerrepo.findAll();
    ...
    public HttpEntity<ResponseBean> findByDistributorcode(@RequestBody FindByBean findByBean) throws Exception {
        ...
        List<com.app.shared.salesboundedcontext.sales.Retailer> lstretailer = retailerrepo.findByDistributorcode((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("SBCSA124100200");
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws Exception {
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        com.app.shared.salesboundedcontext.sales.Retailer lstretailer = retailerrepo.findById((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("SBCSA124100200");
        com.athena.server.pluggable.utils.bean.ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "Retailer"));
        responseBean.add("data", lstretailer);
