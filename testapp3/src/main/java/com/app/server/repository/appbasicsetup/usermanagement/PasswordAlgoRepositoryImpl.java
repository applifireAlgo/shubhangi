...
@Repository
@SourceCodeAuthorClass(createdBy = "shubhangivhanale@gmail.com", updatedBy = "shubhangivhanale@gmail.com", versionNumber = "2", comments = "Repository for PasswordAlgo Master table Entity", complexity = Complexity.LOW)
public class PasswordAlgoRepositoryImpl extends SearchInterfaceImpl implements PasswordAlgoRepository<PasswordAlgo> {
    ...
    public List<PasswordAlgoInterface> findAll() throws Exception {
        ...
        java.util.List<com.spartan.server.password.interfaces.PasswordAlgoInterface> query = emanager.createQuery("select u from PasswordAlgo u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<PasswordAlgo> save(List<PasswordAlgo> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            com.app.shared.appbasicsetup.usermanagement.PasswordAlgo obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.app.shared.appbasicsetup.usermanagement.PasswordAlgo s = emanager.find(com.app.shared.appbasicsetup.usermanagement.PasswordAlgo.class, id);
        emanager.remove(s);
    ...
    public PasswordAlgo findById(String algoId) throws Exception {
        ...
        com.app.shared.appbasicsetup.usermanagement.PasswordAlgo listOfPasswordAlgo = (com.app.shared.appbasicsetup.usermanagement.PasswordAlgo) query.getSingleResult();
