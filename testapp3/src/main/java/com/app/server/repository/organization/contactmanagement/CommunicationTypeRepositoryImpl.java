...
@Repository
@SourceCodeAuthorClass(createdBy = "shubhangivhanale@gmail.com", updatedBy = "shubhangivhanale@gmail.com", versionNumber = "2", comments = "Repository for CommunicationType Master table Entity", complexity = Complexity.LOW)
public class CommunicationTypeRepositoryImpl extends SearchInterfaceImpl implements CommunicationTypeRepository<CommunicationType> {
    ...
    public List<CommunicationType> findAll() throws Exception {
        ...
        java.util.List<com.app.shared.organization.contactmanagement.CommunicationType> query = emanager.createQuery("select u from CommunicationType u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<CommunicationType> save(List<CommunicationType> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            com.app.shared.organization.contactmanagement.CommunicationType obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.app.shared.organization.contactmanagement.CommunicationType s = emanager.find(com.app.shared.organization.contactmanagement.CommunicationType.class, id);
        emanager.remove(s);
    ...
    public CommunicationType findById(String commType) throws Exception {
        ...
        com.app.shared.organization.contactmanagement.CommunicationType listOfCommunicationType = (com.app.shared.organization.contactmanagement.CommunicationType) query.getSingleResult();
