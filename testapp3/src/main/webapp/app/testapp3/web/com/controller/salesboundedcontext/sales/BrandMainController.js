Ext.define('Testapp3.testapp3.web.com.controller.salesboundedcontext.sales.BrandMainController', {
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#BrandForm');
     ...
     hideDataBrowser: function() {
          var form = this.view.down('#BrandForm');
          var grid = this.view.down('#BrandGrid');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var gridPanel = this.view.up().down('#BrandGrid');
               ...
               var formPanel = this.getView().up().down('#BrandForm');
               jsonData = {
                    'findKey': primaryKey
               }
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          ...
          var data = this.findRecordById(this.view.restURL, jsonData);
          var treePanel = this.view.up().up().down('#BrandTree');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#BrandForm').down('#' + me.column.dataIndex + '').store;
