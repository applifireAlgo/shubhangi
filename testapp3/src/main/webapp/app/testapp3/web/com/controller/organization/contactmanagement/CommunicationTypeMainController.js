Ext.define('Testapp3.testapp3.web.com.controller.organization.contactmanagement.CommunicationTypeMainController', {
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#CommunicationTypeForm');
     ...
     hideDataBrowser: function() {
          var form = this.view.down('#CommunicationTypeForm');
          var grid = this.view.down('#CommunicationTypeGrid');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var formPanel = this.getView().up().down('#CommunicationTypeForm');
               jsonData = {
                    'findKey': primaryKey
               }
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#CommunicationTypeForm').down('#' + me.column.dataIndex + '').store;
