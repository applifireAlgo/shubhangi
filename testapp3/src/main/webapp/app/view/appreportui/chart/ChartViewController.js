Ext.define('Testapp3.view.appreportui.chart.ChartViewController', {
			...
			if(chart[i].hasOwnProperty("group")&& chart[i].group==true){
				this.getView().add({xtype:'groupChartPanel',"groupChartJson":chart[i].groupCharts,
							...
							tbar:{
								...
								items:[{xtype:'displayfield',value:chart[i].chartTitle,fieldStyle:{fontWeight:"normal",fontSize:"14px",fontColor:"#424242"}}],style:{ background:"#f6f6f6"}
							},
							margin:10,
