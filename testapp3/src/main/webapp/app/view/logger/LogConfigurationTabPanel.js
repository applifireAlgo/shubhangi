...
Ext
		.define(
				'Testapp3.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Testapp3.view.logger.tabs.details.DetailsTab',
							'Testapp3.view.logger.tabs.fileconnector.FileConnectorTab',
							'Testapp3.view.logger.tabs.dbconnector.DBConnectorTab',
							'Testapp3.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Testapp3.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Testapp3.view.logger.LogConfigurationTabPanelController',
