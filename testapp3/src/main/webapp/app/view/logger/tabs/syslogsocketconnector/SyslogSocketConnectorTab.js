 ...
 * 
 */
Ext.define('Testapp3.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Testapp3.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
