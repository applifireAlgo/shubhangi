Ext.define('Testapp3.view.desktop.design.drawer.main.MainPanelController', {
    ...
    onMyProfileClick : function()
    {
         ...
         this.pushViewInMainTab( "Testapp3.view.usermanagement.enduser.UserProfile","My Profile","menuAction","Testapp3.view.usermanagement.enduser.UserProfile");
    },
    
    onChangePwdClick:function()
    {
      
         this.pushViewInMainTab( "Testapp3.view.usermanagement.enduser.ChangePwd","Change Password","menuAction","Testapp3.view.usermanagement.enduser.ChangePwd");
    },
     onCloudClick : function()
    {
        
        this.pushViewInMainTab("Testapp3.view.clouddrive.CloudDrive","Cloud Drive","menuAction","Testapp3.view.clouddrive.CloudDrive");
    },
