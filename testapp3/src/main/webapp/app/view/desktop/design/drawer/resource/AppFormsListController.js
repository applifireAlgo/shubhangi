Ext.define('Testapp3.view.desktop.design.drawer.resource.AppFormsListController', {
            ...
            success : function(response,sender){
                ...
                var data = Ext.decode(menus.response.data);
                    ...
                    for (var i = 0; i <= data.length; i++) {
                        var menuObj = data[i];
                        var menuNode = appFormListRoot.store.findRecord("menuId",menuObj?menuObj.menuId:"");
