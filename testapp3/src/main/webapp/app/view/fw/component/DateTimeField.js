 ...
 */
Ext.define('Testapp3.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Testapp3.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Testapp3.view.fw.component.DateTimePicker(o);
    },
