Ext.define('Testapp3.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Testapp3.view.usermanagement.admin.AddUserDetailsViewModel', 'Testapp3.model.AddUserDataModel' ],
