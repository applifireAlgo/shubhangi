Ext.define('Testapp3.view.usermanagement.admin.UserPasswordReset', {
	extend : 'Ext.form.Panel',
	requires : [ 'Testapp3.view.usermanagement.admin.UserPasswordResetController' ],
