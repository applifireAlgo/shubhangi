Ext.define('Testapp3.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Testapp3.view.usermanagement.admin.UserPasswordReset',
	            'Testapp3.view.usermanagement.admin.AddUserDetails',
	            'Testapp3.view.usermanagement.admin.ViewUser'],
