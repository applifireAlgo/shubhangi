 ...
 * 
 */
Ext.define('Testapp3.view.securityconfig.SecurityQuestionController', {
	...
	addQuestionToGrid : function(questions)
	{
		...
		for(var i = 0; i<questions.length; i++)
		{
			...
			var rec = {"questionId" : question.questionId, "levelid" : question.levelid, "question" : question.question, "questionDetails" : question.questionDetails, "version_id" : question.versionId}
