 ...
 * 
 */
Ext.define('Testapp3.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Testapp3.view.securityconfig.SecurityConfigController',
			'Testapp3.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
