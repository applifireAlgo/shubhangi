 ...
 * 
 */
Ext.define('Testapp3.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Testapp3.view.logalarm.mainscreen.AddLogAlarmController',
			'Testapp3.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Testapp3.view.logalarm.mainscreen.AppAlarmPanel',
