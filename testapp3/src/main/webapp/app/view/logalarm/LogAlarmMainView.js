 ...
 * 
 */
Ext.define('Testapp3.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Testapp3.view.logalarm.LogAlarmMainViewController',
			'Testapp3.view.logalarm.tree.LogAlarmTreePanel',
			'Testapp3.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
