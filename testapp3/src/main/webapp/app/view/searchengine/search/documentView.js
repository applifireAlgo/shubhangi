Ext
		.define(
				'Testapp3.view.searchengine.search.documentView',
				{
					...
					requires : [
							...
							'Testapp3.view.searchengine.search.documentController',
							'Testapp3.view.searchengine.search.RowExpander' ],
					...
					titleTpl : '<div class="text-wrapper">'
							...
							+ '<div class="news-small"> <span class="news-author">{userFullName}</span>'
