Ext
		.define(
				'Testapp3.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Testapp3.view.searchengine.search.SearchEngineMainPanelController','Testapp3.view.searchengine.search.PanelHeaderField' ,'Testapp3.view.searchengine.search.ReportGridView','Testapp3.view.searchengine.search.ReportChartView','Testapp3.view.searchengine.search.documentView','Testapp3.view.searchengine.search.DouMeanView','Testapp3.view.googlemaps.map.MapPanel'],
