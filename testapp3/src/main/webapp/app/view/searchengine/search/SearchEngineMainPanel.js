Ext.define('Testapp3.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Testapp3.view.searchengine.search.NorthPanel', 'Testapp3.view.searchengine.search.SearchResult','Testapp3.view.searchengine.search.SearchEngineMainPanelController'],
