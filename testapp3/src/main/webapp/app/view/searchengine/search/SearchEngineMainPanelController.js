Ext.define('Testapp3.view.searchengine.search.SearchEngineMainPanelController',{
	...
	doSearch:function(myView,searchText,oprationType)
	{
		...
		.request({
			...
			url : 'secure/SearchEngineService/getSearchResult?searchString='
				...
				success : function(response) {
					...
					result =  Ext.decode(result.response.data.message);
					doUMeanPanel = myView
					.down("#doUMeanPanel");
					...
					statusPanel.update("<font size ='2' color='#808080'>"
							+ result.status
							+ "</font>");
					Ext.MessageBox.hide();
				},
	...
	//This method is not used anymor in new themed app
